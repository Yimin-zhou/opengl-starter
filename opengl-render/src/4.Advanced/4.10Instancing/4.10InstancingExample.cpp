...
// camera
Camera camera(glm::vec3(0.0f, 0.0f, 105.0f));
...
int main()
{
	...
	// -------------------------
	Shader shader("src/4.Advanced/4.10Instancing/4.10metroVS.glsl", "src/4.Advanced/4.10Instancing/4.10metroFS.glsl");
	Shader planetShader("src/4.Advanced/4.10Instancing/4.10planetVS.glsl", "src/4.Advanced/4.10Instancing/4.10metroFS.glsl");
